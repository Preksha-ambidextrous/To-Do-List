...
class DailyRoutineGenerator:
    def __init__(self, root):
        ...
        self.root.configure(bg="#C7B8EA")  # Lavender background color
        self.root.geometry("550x600")  # Increase the size of the GUI

        # Create project heading at the top
        self.project_heading = tk.Label(root, text="Daily Routine Generator", font=("Monospace", 24, "bold"), fg="#AA362F", bg="#bcc2c4")
        self.project_heading.grid(row=0, column=0, columnspan=2, padx=10, pady=10)

        # Create input fields and buttons
        self.task_label = tk.Label(root, text="Enter Task:", font=("Arial", 14), bg="#C7B8EA")
        ...
        self.task_list_frame = tk.Frame(root, bg="#C7B8EA")
        self.task_list_frame.grid(row=3, column=0, columnspan=2, padx=10, pady=10)

        # Create column headings
        self.task_heading = tk.Label(self.task_list_frame, text="Task", font=("Arial", 14, "bold"), bg="#C7B8EA")
